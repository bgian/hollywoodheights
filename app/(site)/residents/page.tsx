...
const TIMELINE_ITEMS = [
  ...
  { id: "unhoused-response", label: "Unhoused Response" },
  { id: "emergency", label: "Emergency" },
  { id: "lapd-trespassing", label: "LAPD Trespassing" },
];

const LAPD_FORM_URL =
  "https://drive.google.com/file/d/1oq7X9_y_RRmz7WquipVbaGlF1lWDeV6o/view?usp=sharing";

const lapdLink = (href: string, children: ReactNode) => (
  <a
    href={href}
    target="_blank"
...
const LAPD_STEPS: { n: number; title: string; points: ReactNode[] }[] = [
  {
    n: 1,
  ...
  },
  {
    ...
    points: [
      <>A copy of the Trespass Arrest Authorization Form can be {lapdLink(LAPD_FORM_URL, "downloaded here")}.</>,
      "Fill in all required fields: property address, owner information, and description of the property.",
      <>Take the completed form to a Notary Public for signature and seal. UPS stores, banks, and many offices offer notary services. Online notaries such as {lapdLink("https://www.office.fedex.com/default/online-notary", "FedEx")}, {lapdLink("https://www.notarize.com/", "Notarize.com")}, and {lapdLink("https://docusign.onenotary.us/acts/no_account/d7128fb7-9531-4ce9-9eeb-055eceac1c8b", "DocuSign")} are also available.</>,
...
export default function HistoryPage() {
  return (
    <div>
      ...
      {/* Unhoused Response */}
      <section id="unhoused-response" className="py-16 sm:py-20" style={{ scrollMarginTop: "5rem" }}>
        <div className="mx-auto max-w-3xl px-6">
          <h2 className="mb-8 text-2xl font-light tracking-wide text-cream sm:text-3xl">
            Unhoused Response
          </h2>
      ...
      {/* Emergency */}
      <section id="emergency" className="py-16 sm:py-20" style={{ scrollMarginTop: "5rem" }}>
        <div className="mx-auto max-w-3xl px-6">
          <h2 className="mb-8 text-2xl font-light tracking-wide text-cream sm:text-3xl">
            Emergency
          </h2>
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <ul className="mt-2 space-y-1 text-base leading-relaxed text-cream">
                ...
                <li>If your building or home appears to be unsafe, begin evacuation if it is safe to do so</li>
            ...
            <div>
              <h3 className="text-lg font-medium text-cream">Non-Emergency Contacts</h3>
              <p className="mt-2 text-base leading-relaxed text-cream">
                For non-emergencies, call the Non-Emergency Police Line:{" "}
                <a href="tel:+18772755273" className="underline decoration-cream underline-offset-4 hover:opacity-70">877-ASK-LAPD (877-275-5273)</a>
              </p>
            </div>
      ...
      <section id="lapd-trespassing" className="py-16 sm:py-20" style={{ scrollMarginTop: "5rem" }}>
        <div className="mx-auto max-w-3xl px-6">
          <h2 className="mb-3 text-2xl font-light tracking-wide text-cream sm:text-3xl">
            LAPD Trespassing Arrest Authorization
          </h2>
          <p className="mb-8 text-base leading-relaxed text-cream">
            ...
            {LAPD_STEPS.map((step) => (
              <div key={step.n} className="rounded-[24px] border border-cream/18 p-8">
                <div className="flex items-center gap-4">
                  ...
                  <h3 className="text-lg font-light tracking-wide text-cream sm:text-xl">
                    {step.title}
                  </h3>
                </div>
