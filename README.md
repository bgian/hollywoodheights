...
Newsletter signup on the Contact page links out to a [Constant Contact hosted landing page](https://lp.constantcontactpages.com/sl/fIheEaU), so it needs no configuration.
